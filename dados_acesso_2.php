...
<body>
    <div class="top-0 start-0 end-0">
        ...
        <div class="card position-absolute translate-middle-x centraliza" id="cardAlteracao">
            <div class="card-body">
                <?php mostraMudanca() ?>
                        ...
                        <div class="botoesCores alinhaCentro">
                            <?php
                                ...
                                if (!isset($btnApagaConta)) {
                                    ...
                                    echo '<button type="submit" name="btnLogout" class="btn btn-outline-primary marginLateral">Deslogar</button>';
                                    echo '<button type="submit" name="btnApagaConta" class="btn btn-outline-primary marginLateral">Apagar conta</button>';
                                }
                                else{
                                    echo            'Tem certeza? ';
